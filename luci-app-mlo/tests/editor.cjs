...
const src=fs.readFileSync(require('path').join(__dirname, '../htdocs/luci-static/resources/view/mlo.js'),'utf8');
const view=Function('view','form','uci','ui','poll','rpc','L','_','E',src)({extend:v=>v},form,uci,{createHandlerFn:(c,fn)=>fn,addNotification:()=>{}},{},{declare:()=>()=>Promise.resolve({})},L,s=>s,E);
