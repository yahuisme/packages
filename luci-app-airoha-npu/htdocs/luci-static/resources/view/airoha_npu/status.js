...
var themeCSS = '\
.npu-dashboard{--npu-chart-accent:var(--success,light-dark(#15803d,#16a34a))}\
.npu-dashboard .npu-summary-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,150px),1fr));gap:8px;margin:16px 0}\
.npu-dashboard .npu-summary-card,.npu-dashboard .npu-panel{background:var(--cbi-section-bg,transparent);border:1px solid var(--cbi-border-color,var(--hairline,#ddd));border-radius:6px;box-sizing:border-box}\
.npu-dashboard .npu-summary-card{min-width:0;min-height:96px;padding:8px 16px;display:flex;flex-direction:column;justify-content:center;gap:4px;line-height:1.5;overflow-wrap:anywhere}.npu-dashboard .npu-card-title,.npu-dashboard .npu-detail-group-title{color:var(--cbi-muted-color,var(--text-muted,inherit))}.npu-dashboard .npu-card-value{display:block;font-size:1.125em;font-weight:600;font-variant-numeric:tabular-nums}.npu-dashboard .npu-card-sub{color:var(--cbi-muted-color,var(--text-muted,inherit))}\
.npu-dashboard .npu-frequency-chart{margin:16px 0;min-width:0}.npu-dashboard .npu-chart-header{display:flex;justify-content:space-between;gap:8px;}.npu-dashboard .npu-frequency-chart svg{display:block;width:100%;height:200px;color:inherit}.npu-dashboard .npu-chart-caption{text-align:center}.npu-dashboard .npu-chart-grid{stroke:currentColor;stroke-width:1;opacity:.12}.npu-dashboard .npu-chart-line{fill:none;stroke:var(--npu-chart-accent);stroke-width:1.5;stroke-linejoin:round;stroke-linecap:round}.npu-dashboard .npu-chart-point{fill:var(--npu-chart-accent)}.npu-dashboard .npu-chart-area{fill:var(--npu-chart-accent);fill-opacity:.10;stroke:none}\
.npu-dashboard .npu-panel{padding:16px;margin:16px 0}.npu-dashboard .npu-panel-title{padding-bottom:8px;margin-bottom:8px;border-bottom:1px solid var(--cbi-border-color,var(--hairline,#ddd))}.npu-dashboard .npu-detail-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,280px),1fr));gap:0 24px}.npu-dashboard .npu-detail-group-title{margin:8px 0}.npu-dashboard .npu-detail-row{display:flex;justify-content:space-between;gap:16px;padding:8px 0;border-bottom:1px solid var(--cbi-border-color,var(--hairline,rgba(128,128,128,.12)))}.npu-dashboard .npu-detail-label{color:var(--cbi-muted-color,var(--text-muted,inherit))}.npu-dashboard .npu-detail-group{min-width:0}.npu-dashboard .npu-detail-value{min-width:0;text-align:right;overflow-wrap:anywhere}\
@media(max-width:760px){.npu-dashboard .npu-summary-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.npu-dashboard .npu-detail-grid{grid-template-columns:1fr}}@media(max-width:480px){.npu-dashboard .npu-summary-grid{grid-template-columns:1fr}.npu-dashboard .npu-panel{padding:8px}}\
';
	...
	render: function(data) {
		...
		var page = E('div', { 'class': 'cbi-map npu-dashboard' }, [
			...
			E('div', { 'class': 'npu-frequency-chart' }, [
				E('h3', { 'class': 'npu-chart-header cbi-section-title' }, [
			...
			E('div', { 'class': 'npu-panel' }, [
				E('h3', { 'class': 'npu-panel-title cbi-section-title' }, _('SoC & NPU Details')),
