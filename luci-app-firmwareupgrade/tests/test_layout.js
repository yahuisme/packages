...
document.body.append(app.render({local_version:'OpenWrt SNAPSHOT r31000-abcdef123456',repository:'VIKINGYFY/OpenWRT-CI',release_pattern:'IPQ807X-WIFI-YES-*',asset_pattern:'*linksys_mx4200v2-squashfs-sysupgrade-*.bin',download_proxy:'https://gh-proxy.com/'}));
