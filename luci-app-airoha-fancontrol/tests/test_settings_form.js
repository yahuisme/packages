...
(async () => {
 try {
  ...
  assert.deepEqual([...svg.querySelectorAll('.fan-curve-x-tick')].map(e=>e.textContent),['0','20','40','60','80','100']);
  assert.deepEqual([...svg.querySelectorAll('.fan-curve-y-tick')].map(e=>e.textContent),['0','64','128','192','255']);
